...
![image](/assets/img/WPT/cbjs-mock-test/image3.png)
<p style="text-align:center"><em>Scan Directory</em></p>

![image](/assets/img/WPT/cbjs-mock-test/image4.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image7.png)
<p style="text-align:center"><em>input xử lý trên host phụ trợ</em></p>

![image](/assets/img/WPT/cbjs-mock-test/image8.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image9.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image10.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image11.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image12.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image13.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image14.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image15.png)
<p style="text-align:center"><em>Public một kết nối TCP ra ngoài internet bằng ngrok</em></p>

![image](/assets/img/WPT/cbjs-mock-test/image16.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image17.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image18.png)

Hàm `getinfoFromUserid` lấy thông tin thông qua `id` một cách đơn giản. 

![image](/assets/img/WPT/cbjs-mock-test/image19.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image20.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image21.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image22.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image23.png)

Kiểm tra lại tài khoản.

![image](/assets/img/WPT/cbjs-mock-test/image24.png)
...
id=0 OR 1=1-- a
```
![image](/assets/img/WPT/cbjs-mock-test/image25.png)
...
id=0 OR SLEEP(10)-- a
```
![image](/assets/img/WPT/cbjs-mock-test/image26.png)
...
Kết quả:
![image](/assets/img/WPT/cbjs-mock-test/image29.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image30.png)

Cuối cùng, ta lấy giá trị trong cột `flag` của bảng `flag`:

![image](/assets/img/WPT/cbjs-mock-test/image31.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image32.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image33.png)

Nếu mình truyền vào một tag HTML là `<h1>Test</h1>` thì nó vẫn có thể `render`.

![image](/assets/img/WPT/cbjs-mock-test/image34.png)
...
![image](/assets/img/WPT/cbjs-mock-test/image35.png)
