---
title: Matching Patching Round II - WPT
date: 2025-07-07
tags: [game]
...
![image](/assets/img/WPT/matching-patching-round2/image1.png)

Các matching được thể hiện dưới đâu: 

![image](/assets/img/WPT/matching-patching-round2/image2.png)
...
![image](/assets/img/WPT/matching-patching-round2/image3.png)

## FLAG 1 (SQL Injection) -> Nằm trong một bảng bí mật của DB 

![image](/assets/img/WPT/matching-patching-round2/image4.png)
...
![image](/assets/img/WPT/matching-patching-round2/image5.png)

Lúc đó câu lệnh query sẽ là: 

![image](/assets/img/WPT/matching-patching-round2/image6.png)

![image](/assets/img/WPT/matching-patching-round2/image7.png)
...
![image](/assets/img/WPT/matching-patching-round2/image8.png)
Nhưng mình bị chặn từ `jutsu` cho nên mình thay bằng `JUTSU`

![image](/assets/img/WPT/matching-patching-round2/image9.png)

## FLAG 3 (SSRF) -> Nằm trong tập tin `flag.php` tại thư mục gốc của webserver 

![image](/assets/img/WPT/matching-patching-round2/image10.png)
...
![image](/assets/img/WPT/matching-patching-round2/image11.png)

Và ở team_4 cũng chọn như sau:

![image](/assets/img/WPT/matching-patching-round2/image12.png)

Nhưng patch này thì hoàn toàn ko thể chặn `SSRF` --> hoàn toàn khai thác dễ dàng. 

![image](/assets/img/WPT/matching-patching-round2/image13.png)
...
![image](/assets/img/WPT/matching-patching-round2/image14.png)
