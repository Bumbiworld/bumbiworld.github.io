---
title: Matching Patching Round I - WPT
date: 2025-02-15
tags: [game]
...
![image](/assets/img/WPT/matching-patching-round1/image1.png)
Các patching được thể hiện dưới đây: 
![image](/assets/img/WPT/matching-patching-round1/image2.png)
...
![image](/assets/img/WPT/matching-patching-round1/image3.png)

## FLAG 3 (SSRF) -> Nằm trong file `flag.php` tại thư mục gốc của webserver

![image](/assets/img/WPT/matching-patching-round1/image4.png)
...
![image](/assets/img/WPT/matching-patching-round1/image5.png)
...
![image](/assets/img/WPT/matching-patching-round1/image6.png)

Mình chạy serialize thì được như sau: 

![image](/assets/img/WPT/matching-patching-round1/image7.png)
...
![image](/assets/img/WPT/matching-patching-round1/image8.png)

## FLAG 1 (SQL Injection) -> Nằm trong một bảng bí mật của DB 

Source như sau:
![image](/assets/img/WPT/matching-patching-round1/image9.png)
...
![image](/assets/img/WPT/matching-patching-round1/image10.png)
