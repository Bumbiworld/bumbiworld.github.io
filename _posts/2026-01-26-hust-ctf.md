---
title: Early Bird - HUST CTF
date: 2026-01-26
tags: [ctf, web, phar deserializtion]
...
[phar_deserialization.zip](https://drive.google.com/file/d/12DLzefMxSTdWNZpeWbNmooQMnApDt_CR/view?usp=drive_link)
...
![image.png](/assets/img/CTF/hust/image%202.png)
...
Và mình thấy có 1 file **`upload.php`** → cho nên mình cần đọc qua.
 ...
 ```php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['avatar'])) {
        ...
        $isImage = getimgize($file['tmp_name']);
...
Và nó có kiểm tra thêm size của hình ảnh qua hàm **`getimgize`** → check header của file hình ảnh. 
...
![image.png](/assets/img/CTF/hust/image%203.png)
...
![image.png](/assets/img/CTF/hust/image%204.png)

Thì thu được 1 đường dẫn lưu file.

![image.png](/assets/img/CTF/hust/image%205.png)

Mình tạo dữ liệu serialize để nhét vào **`seal`** 

![image.png](/assets/img/CTF/hust/image%206.png)

Sau đó mình quăng vào burpsuite.

![image.png](/assets/img/CTF/hust/image%207.png)
...
![image.png](/assets/img/CTF/hust/image%208.png)
...
![image.png](/assets/img/CTF/hust/image%2011.png)
...
Thì ở đây có thể đặt ra một câu hỏi là tại sao ko dùng **`GIF89a`** trần thôi ?? phải dùng GIF 1x1 một cách đầy đủ vì hàm **`getimgize`** chỉ chấp nhận một cách đầy đủ.

Sau khi mình tạo ra file **`.gif`** → lặp lại các bước như trên.

![image.png](/assets/img/CTF/hust/image%2015.png)
