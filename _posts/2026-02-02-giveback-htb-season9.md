---
title: Giveback Retired Machine [Medium]
date: 2026-02-02
tags: [htb-machine, medium, linux, season9]
categories: [Writeups, HTB-Machines]
author: bumbi.203_
---
...
![image](/assets/img/HTB/season9/Giveback/image1.png)
...
- **`http://giveback.htb/wp-sitemap-posts-1.xml` ⇒ `http://giveback.htb/2024/09/hello-world`**
    ...
    ![image](/assets/img/HTB/season9/Giveback/image5.png)
    
    Truy cập mình được dẫn đến như sau.
    
    ![image](/assets/img/HTB/season9/Giveback/image6.png)
    
- **`http://giveback.htb/wp-sitemap-posts-1.xml`** ⇒ 5 url khác.
    
    ![image](/assets/img/HTB/season9/Giveback/image7.png)
    
    - **`http://giveback.htb`** ⇒ trang web lúc đầu
    - **`http://giveback.htb/sample-page/`**
        
        ![image](/assets/img/HTB/season9/Giveback/image8.png)
        
    - **`http://giveback.htb/donation-confirmation`**
        
        ![image](/assets/img/HTB/season9/Giveback/image9.png)
        
    - **`http://giveback.htb/donation-failed/`**
        
        ![image](/assets/img/HTB/season9/Giveback/image10.png)
        
    - **`http://giveback.htb/dornor-dashboard/`**
        
        ![image](/assets/img/HTB/season9/Giveback/image11.png)
        
- **`http://giveback.htb/wp-sitemap-posts-give_forms-1.xml` ⇒ `http://giveback.htb/the-things-we-need`**
    
    ![image](/assets/img/HTB/season9/Giveback/image12.png)
    
    Truy cập được dẫn đến như sau. 
    
    ![image](/assets/img/HTB/season9/Giveback/image13.png)
    
- **`http://giveback.htb/wp-sitemap-taxonomies-category-1.xml` ⇒ `http://giveback.htb/category/uncategorized/`**
    
    ![image](/assets/img/HTB/season9/Giveback/image14.png)
    
    Truy cập được dẫn đến. 
    
    ![image](/assets/img/HTB/season9/Giveback/image15.png)
    
- **`http://giveback.htb/wp-sitemap-users-1.xml` ⇒ `http://giveback.htb/author/user/`**
    
    ![image](/assets/img/HTB/season9/Giveback/image16.png)
    
    Mình được dẫn tới đây. 
    
    ![image](/assets/img/HTB/season9/Giveback/image17.png)
...
- **`http://giveback.htb/the-things-we-need`**
    ...
    ![image](/assets/img/HTB/season9/Giveback/image18.png)
    
    ![image](/assets/img/HTB/season9/Giveback/image19.png)
    

![image](/assets/img/HTB/season9/Giveback/image20.png)

![image](/assets/img/HTB/season9/Giveback/image21.png)

Mình test thử chức năng donate → tui đã thử với 100$

![image](/assets/img/HTB/season9/Giveback/image22.png)

Sau khi đã donate thì mình để 1 link phía dưới **`Go to my Dashboard` →** sẽ được chuyển về **`Donor Dashboard`** 

![image](/assets/img/HTB/season9/Giveback/image23.png)

- **`http://giveback.htb/dornor-dashboard`**
    
    ![image](/assets/img/HTB/season9/Giveback/image24.png)
...
- **`http://giveback.htb/category/uncategorized/`**
    ...
    ![image](/assets/img/HTB/season9/Giveback/image25.png)
    
    ![image](/assets/img/HTB/season9/Giveback/image26.png)
...
![image](/assets/img/HTB/season9/Giveback/image27.png)
...
![image](/assets/img/HTB/season9/Giveback/image28.png)
...
![image](/assets/img/HTB/season9/Giveback/image29.png)
...
![image](/assets/img/HTB/season9/Giveback/image30.png)

Nó sẽ xuất hiện 1 interface, mình chỉ cần click **`Connect`** tới Admin

![image](/assets/img/HTB/season9/Giveback/image31.png)

![image](/assets/img/HTB/season9/Giveback/image32.png)
...
![image](/assets/img/HTB/season9/Giveback/image33.png)

![image](/assets/img/HTB/season9/Giveback/image34.png)
...
![image](/assets/img/HTB/season9/Giveback/image35.png)

Nhìn thấy thì mình đã có connect về server của mình. 

⇒ tiếp theo mình sẽ add route tới **`10.43.2.0/24`** .

![image](/assets/img/HTB/season9/Giveback/image36.png)

Mình thêm các thông tin vào. 

![image](/assets/img/HTB/season9/Giveback/image37.png)

Sau đó mình chọn vào **`start relay`** 

![image](/assets/img/HTB/season9/Giveback/image38.png)

Mình thử ping vào mạng bên trong. 

![image](/assets/img/HTB/season9/Giveback/image39.png)

Giờ thì mình truy cập qua port `5000` 

![image](/assets/img/HTB/season9/Giveback/image40.png)
...
![image](/assets/img/HTB/season9/Giveback/image41.png)

Quay lại tab penelope 

![image](/assets/img/HTB/season9/Giveback/image42.png)

Kiểm tra thì mình dược kết quả như sau

![image](/assets/img/HTB/season9/Giveback/image43.png)
...
![image](/assets/img/HTB/season9/Giveback/image44.png)
...
![image](/assets/img/HTB/season9/Giveback/image45.png)

Từ đây mình vào ssh như đã scan port lúc trên

![image](/assets/img/HTB/season9/Giveback/image46.png)

Từ đây mình khám phá trên user này.

![image](/assets/img/HTB/season9/Giveback/image47.png)
...
![image](/assets/img/HTB/season9/Giveback/image48.png)

Thấy **`/opt/debug`** chạy được → nên chạy thử.

![image](/assets/img/HTB/season9/Giveback/image49.png)
...
![image](/assets/img/HTB/season9/Giveback/image50.png)
...
![image](/assets/img/HTB/season9/Giveback/image51.png)
...
![image](/assets/img/HTB/season9/Giveback/image52.png)

![image](/assets/img/HTB/season9/Giveback/image53.png)