...
![image.png](/assets/img/WPT/os-command/image.png)
...
![image.png](/assets/img/WPT/os-command/image1.png)

Mình tiến hành đọc source của nó.

![image.png](/assets/img/WPT/os-command/image2.png)
...
![image.png](/assets/img/WPT/os-command/image3.png)
...
![image.png](/assets/img/WPT/os-command/image4.png)

## 🧪 Level 2

---

![image.png](/assets/img/WPT/os-command/image5.png)

Nhưng tương tự như level 2 → cho nên mình sẽ đọc source. 

![image.png](/assets/img/WPT/os-command/image6.png)
...
![image.png](/assets/img/WPT/os-command/image7.png)

Câu lệnh **`ping`** đã ko thực hiện được thì nó sẽ thực hiện câu lệnh thứ hai mình truyền vào. Hoặc mình có thể dùng **`&&`** 

![image.png](/assets/img/WPT/os-command/image8.png)

Như vậy mình đã quyền để thực hiện đọc toàn bộ file ở mọi nơi mình muốn.

![image.png](/assets/img/WPT/os-command/image9.png)

## 🧪 Level 3

---

![image.png](/assets/img/WPT/os-command/image10.png)
...
![image.png](/assets/img/WPT/os-command/image11.png)

Hoặc mình có thể dùng **sub Command**

- **`$()`**

![image.png](/assets/img/WPT/os-command/image12.png)

- **``**

![image.png](/assets/img/WPT/os-command/image13.png)

Như vậy mình đã có thể đọc file tùy ý trên server. 

![image.png](/assets/img/WPT/os-command/image14.png)
...
![image.png](/assets/img/WPT/os-command/image15.png)

Mình tiến hành đọc source code. 

![image.png](/assets/img/WPT/os-command/image16.png)
...
![image.png](/assets/img/WPT/os-command/image17.png)

Dựa vào hai dấu hiệu in ra như trên mình có ý tưởng ghi toàn bộ nội dung vào một file sau đó gửi ra ngoài internet. 

![image.png](/assets/img/WPT/os-command/image18.png)

Quan sát tại webhook. 

![image.png](/assets/img/WPT/os-command/image19.png)

Như vậy thì có thể thực hiện đọc file sau đó gửi sang internet.

![image.png](/assets/img/WPT/os-command/image20.png)

## 🧪 Level 5

---

![image.png](/assets/img/WPT/os-command/image21.png)

Tương tự như level 4 mình cũng có chức năng **`backup`** 

![image.png](/assets/img/WPT/os-command/image22.png)

Nhưng lần này khi đó trước khi đi vào mình sẽ phải đi qua một proxy. 

![image.png](/assets/img/WPT/os-command/image23.png)
...
![image.png](/assets/img/WPT/os-command/image24.png)
...
![image.png](/assets/img/WPT/os-command/image25.png)

Sau đó mình truy cập vào file **`exploit.txt`**

![image.png](/assets/img/WPT/os-command/image26.png)

## 🧪 Level 6

---

![image.png](/assets/img/WPT/os-command/image27.png)

Mình review source code. 

![image.png](/assets/img/WPT/os-command/image28.png)

Vẫn tương tự như các level ở trên. Và nó cũng đi qua một proxy.

![image.png](/assets/img/WPT/os-command/image29.png)
...
![image.png](/assets/img/WPT/os-command/image30.png)

Và mình cũng hoàn toàn đặt biến để thực hiện một lệnh gì đó. 

![image.png](/assets/img/WPT/os-command/image31.png)
...
![image.png](/assets/img/WPT/os-command/image32.png)
...
![image.png](/assets/img/WPT/os-command/image33.png)

Sau đó mình lấy nội dung của file này, bằng cách tương tự. 

![image.png](/assets/img/WPT/os-command/image34.png)

## 🧪 Level 7

---

![image.png](/assets/img/WPT/os-command/image35.png)
...
![image.png](/assets/img/WPT/os-command/image36.png)
...
![image.png](/assets/img/WPT/os-command/image37.png)

Rồi mình thử đọc file tương tự như cách tìm path_filename

![image.png](/assets/img/WPT/os-command/image38.png)