---
title: Windows Initial Access - RT
date: 2025-02-05
tags: [recon, redteam]
...
![image](/assets/img/redteam/WindowsInitialAccess/image1.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image2.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image3.png)

Như vậy nhìn thấy thì trên Windows thì có kha khá thứ đặc trưng :”> 

Và cũng khác biệt về cấu trúc file. 

![image](/assets/img/redteam/WindowsInitialAccess/image4.png)

![image](/assets/img/redteam/WindowsInitialAccess/image5.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image6.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image7.png)

Từ đây, nhìn thấy nó có gợi ý để in ra lỗi chi tiết hơn bằng cách set **`web.config`** 

![image](/assets/img/redteam/WindowsInitialAccess/image8.png)

Khi reload lại file → nó in ra chi tiết lỗi

![image](/assets/img/redteam/WindowsInitialAccess/image9.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image10.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image11.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image12.png)

Thì tại sao **`IIS`** có thể làm được như vậy. 

![image](/assets/img/redteam/WindowsInitialAccess/image13.png)

Để tìm hiểu nguyên nhân thì vào file **`applicationHost.config`** quan sát tại dòng 790

![image](/assets/img/redteam/WindowsInitialAccess/image14.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image15.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image16.png)

Thì khi nào lúc nào cũng sẽ có dòng **`Service Descriptiton`** 

![image](/assets/img/redteam/WindowsInitialAccess/image17.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image18.png)

Kết quả trả về sẽ như thế này.

![image](/assets/img/redteam/WindowsInitialAccess/image19.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image20.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image21.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image22.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image23.png)

Và hiện tại nó vẫn hỗ trợ wildcard và ký tự **`?`**.

![image](/assets/img/redteam/WindowsInitialAccess/image24.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image25.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image26.png)

Nhìn thấy nó mở **`ftp`** 

Cho nên mình test thử xem nó có bật anonymous account hay ko ❓❓ 

![image](/assets/img/redteam/WindowsInitialAccess/image27.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image28.png)

![image](/assets/img/redteam/WindowsInitialAccess/image29.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image30.png)

Sau đó mình truy cập shell đã cắm. 

![image](/assets/img/redteam/WindowsInitialAccess/image31.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image32.png)

Mình lại truy cập sang bằng shell mới này. 

![image](/assets/img/redteam/WindowsInitialAccess/image33.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image34.png)

![image](/assets/img/redteam/WindowsInitialAccess/image35.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image36.png)

![image](/assets/img/redteam/WindowsInitialAccess/image37.png)

Sau đó mình cho chạy qua extension trong Burp để đễ thao tác. 

![image](/assets/img/redteam/WindowsInitialAccess/image38.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image39.png)

Quan sát tại server kali thì thấy có request đến. 

![image](/assets/img/redteam/WindowsInitialAccess/image40.png)

Như vậy là đã có file tải xuống. 

![image](/assets/img/redteam/WindowsInitialAccess/image41.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image42.png)

Đây là giao diện của web và cho phép upload. 

Đầu tiên mình cần recon xem nó viết bằng gì.

![image](/assets/img/redteam/WindowsInitialAccess/image43.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image44.png)

![image](/assets/img/redteam/WindowsInitialAccess/image45.png)

Như vậy mình thử upload file **`.txt`** 

![image](/assets/img/redteam/WindowsInitialAccess/image46.png)

Sau khi upload được thì mình có chức năng **`Download`** 

![image](/assets/img/redteam/WindowsInitialAccess/image47.png)

![image](/assets/img/redteam/WindowsInitialAccess/image48.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image49.png)

- **`\windows\System32\drivers\etc\hosts`**

![image](/assets/img/redteam/WindowsInitialAccess/image50.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image51.png)

Quan sát kĩ file này mình thấy như sau: 

![image](/assets/img/redteam/WindowsInitialAccess/image52.png)

- Có file **`bin\tempbin.dll`**

![image](/assets/img/redteam/WindowsInitialAccess/image53.png)

- Có **`c:\TempImageFiles\`** , **`key=ChartImageHandle`** và **`PublicKeyToken`**

![image](/assets/img/redteam/WindowsInitialAccess/image54.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image55.png)

Từ đây mình có tìm các thông tin hữu ích cho mình. 

![image](/assets/img/redteam/WindowsInitialAccess/image56.png)

Và sau đó mình đọc flag này. 

![image](/assets/img/redteam/WindowsInitialAccess/image57.png)

### `ConnectionStrings.config`

![image](/assets/img/redteam/WindowsInitialAccess/image58.png)

Ở đây mình thu được **`User ID`** và **`Password`** → **connect vào msssql**

### MSSQL

![image](/assets/img/redteam/WindowsInitialAccess/image59.png)

Khi login vào thì mình thấy user hiện tại là **`dbo`**. Giờ mình tiếp tục đào bới trong service này. 

![image](/assets/img/redteam/WindowsInitialAccess/image60.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image61.png)

Nhìn kỹ thì mình mới là user **`tempbin`** chưa phải là cao nhất. Và quan sát thì thấy LoginName là **`sa`** thì mình login thử.

![image](/assets/img/redteam/WindowsInitialAccess/image62.png)
...
![image](/assets/img/redteam/WindowsInitialAccess/image63.png)

Từ đây mình đã thực hiện lệnh **`cmd`** như vậy mình hoàn toàn có RCE. 

![image](/assets/img/redteam/WindowsInitialAccess/image64.png)
