---
title: ExpressWay Retired Machine [Easy]
date: 2026-01-27
...
![image1.png](/assets/img/HTB/season9/ExpressWay/image1.png)

- Scan UDP port

![image2.png](/assets/img/HTB/season9/ExpressWay/image2.png)
...
![image3.png](/assets/img/HTB/season9/ExpressWay/image3.png)
...
![image4.png](/assets/img/HTB/season9/ExpressWay/image4.png)
...
![image5.png](/assets/img/HTB/season9/ExpressWay/image5.png)

Tiếp tục dùng option **`--aggressive`** để nó trả về nhiều thông tin hơn như ID/KeyExchange/HASH_R.

![image6.png](/assets/img/HTB/season9/ExpressWay/image6.png)
...
![image7.png](/assets/img/HTB/season9/ExpressWay/image7.png)

Như vậy thì nó đã lưu hash vào trong file **`psk.txt`**

![image8.png](/assets/img/HTB/season9/ExpressWay/image8.png)

Mình sẽ thử crack hash này.

![image9.png](/assets/img/HTB/season9/ExpressWay/image9.png)
...
![image10.png](/assets/img/HTB/season9/ExpressWay/image10.png)

Như vậy thì tiếp tục khai thác trên host này.

![image11.png](/assets/img/HTB/season9/ExpressWay/image11.png)

Nhìn thấy thì chưa leo lên được **`root`.** Giờ mình cần leo quyền.

![image12.png](/assets/img/HTB/season9/ExpressWay/image12.png)
...
![image13.png](/assets/img/HTB/season9/ExpressWay/image13.png)

Nhìn thấy thì có file **`/usr/local/bin/sudo`**. Sau khi, kiểm tra thì nó có version là **`1.9.17`** 

![image14.png](/assets/img/HTB/season9/ExpressWay/image14.png)

Tìm thông tin trên mạng thì nó liên quan đến 1 **`CVE-2025-32463`** 

![image15.png](/assets/img/HTB/season9/ExpressWay/image15.png)
...
![image16.png](/assets/img/HTB/season9/ExpressWay/image16.png)
...
![image17.png](/assets/img/HTB/season9/ExpressWay/image17.png)

![image18.png](/assets/img/HTB/season9/ExpressWay/image18.png)