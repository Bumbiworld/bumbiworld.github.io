...
![image](/assets/img/CTF/mb-bank/sqli/image1.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image2.png)

Và khi truy cập vào các mục như About thì được trả về 1 hình ảnh. 

![image](/assets/img/CTF/mb-bank/sqli/image3.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image4.png)
...
if (isset($_GET['f'])) {
    ...
    if (!file_exists($imagePath)) {
        $html = "<h1>$description</h1>
                <img src='./img/betterttv.gif' alt='kho lam' class='user-image'>";
    } else {
...
<body>
    <header class='header'>
        ...
        <nav>
            <ul class='nav-list'>
                <li><a href='img/betterttv.gif'>Home</a></li>
                <li><a href='img/betterttv.gif'>About</a></li>
                <li><a href='img/betterttv.gif'>Contact</a></li>
            </ul>
        </nav>
    </header>
    <main class='container'>
        <section class='content'>
            $html
            <!-- Buttons to navigate to user img -->
...
![image](/assets/img/CTF/mb-bank/sqli/image5.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image6.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image7.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image8.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image9.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image10.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image11.png)

Nó đã hoàn toàn sleep 10 giây. 

![image](/assets/img/CTF/mb-bank/sqli/image12.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image13.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image14.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image15.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image16.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image17.png)
...
![image](/assets/img/CTF/mb-bank/sqli/image18.png)

Nó hoàn toàn trả về Flag. 

![image](/assets/img/CTF/mb-bank/sqli/image19.png)
