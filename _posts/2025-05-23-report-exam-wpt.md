...
![image](/assets/img/WPT/cbjs-final-exam/image1.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image2.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image5.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image6.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image11.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image12.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image13.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image16.png)

Lấy password thành công

Cuối cùng, ta cần nhập đúng `password` vừa lấy vào trong ô yêu cầu là đã có thể vào được.

![image](/assets/img/WPT/cbjs-final-exam/image17.png)

Truy cập thành công! 

![image](/assets/img/WPT/cbjs-final-exam/image18.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image21.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image22.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image23.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image24.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image29.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image30.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image31.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image34.png)

Gửi link cho admin

Quay lại webhook thì mình đã có được token hợp lệ của admin.

![image](/assets/img/WPT/cbjs-final-exam/image35.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image36.png)

File api.php

Sau đó mình truy cập `/api/admin/sup3rs3cr3t`

![image](/assets/img/WPT/cbjs-final-exam/image37.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image38.png)

role ban đầu là user

![image](/assets/img/WPT/cbjs-final-exam/image39.png)

update role user là admin

![image](/assets/img/WPT/cbjs-final-exam/image40.png)

Kiểm tra lại sau khi update role 

Sau đó mình có thể login tài khoản với vai trò admin đã leo thang đặc quyền thành công.

![image](/assets/img/WPT/cbjs-final-exam/image41.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image42.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image43.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image44.png)

File monolog/monolog 3.0

![image](/assets/img/WPT/cbjs-final-exam/image45.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image46.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image47.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image48.png)

payload Monolog

Sau đó mình gửi file này lên chỗ `Restore`.

![image](/assets/img/WPT/cbjs-final-exam/image49.png)

Request trả về trên webhook

Tiếp theo là `Laravel` với payload như sau:

![image](/assets/img/WPT/cbjs-final-exam/image50.png)

payload Laravel

Sau đó mình gửi file này lên chỗ `Restore`.

![image](/assets/img/WPT/cbjs-final-exam/image51.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image52.png)

Thay đổi payload

Ta sử dụng `ngrok` để công khai một cổng TCP trên máy local ra Internet.

![image](/assets/img/WPT/cbjs-final-exam/image53.png)

Public 1 kết nối TCp ra ngoài internet bằng ngrok

![image](/assets/img/WPT/cbjs-final-exam/image54.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image55.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image56.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image57.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image60.png)

Truyền payload vào trong date

![image](/assets/img/WPT/cbjs-final-exam/image61.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image64.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image65.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image66.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image67.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image68.png)

Copy header bằng extension của BurpSuite

![image](/assets/img/WPT/cbjs-final-exam/image69.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image70.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image71.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image72.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image73.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image74.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image75.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image76.png)

payload test os command injection 

![image](/assets/img/WPT/cbjs-final-exam/image77.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image78.png)

payload test os command injection

![image](/assets/img/WPT/cbjs-final-exam/image79.png)

Thưc hiện payload gửi request ra webhook

![image](/assets/img/WPT/cbjs-final-exam/image80.png)
...
![image](/assets/img/WPT/cbjs-final-exam/image81.png)
