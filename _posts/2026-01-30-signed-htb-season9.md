---
title: Signed Retired Machine [Medium]
date: 2026-01-29
tags: [htb-machine, medium, windows, season9]
...
![image](/assets/img/HTB/season9/Signed/image1.png)
...
![image](/assets/img/HTB/season9/Signed/image2.png)

Tiếp tục tìm hiểu các trong service này có gì.... 

![image](/assets/img/HTB/season9/Signed/image3.png)

![image](/assets/img/HTB/season9/Signed/image4.png)
...
![image](/assets/img/HTB/season9/Signed/image5.png)
...
![image](/assets/img/HTB/season9/Signed/image12.png)
...
![image](/assets/img/HTB/season9/Signed/image13.png)

Như vậy thì khi đó thì sẽ lấy được **role** của **sysadmin** sẽ có các member nào. 

![image](/assets/img/HTB/season9/Signed/image14.png)
...
![image](/assets/img/HTB/season9/Signed/image15.png)

Tiếp theo mình sẽ lấy SID cho **IT** và **MSSQLSVC**. 

![image](/assets/img/HTB/season9/Signed/image16.png)
...
![image](/assets/img/HTB/season9/Signed/image17.png)

Tiếp tục, mình parse của `SIGNED\mssqlsvc`

![image](/assets/img/HTB/season9/Signed/image18.png)
...
![image](/assets/img/HTB/season9/Signed/image19.png)

Cho nên mình cần tính toán như sau: 

![image](/assets/img/HTB/season9/Signed/image20.png)

Hoặc mình chạy trên terminal như sau: 

![image](/assets/img/HTB/season9/Signed/image21.png)

### Bước 3 - Ép buộc tạo ra 1 Silver Ticket để có thể tiếp cận service 

![image](/assets/img/HTB/season9/Signed/image22.png)
...
![image](/assets/img/HTB/season9/Signed/image23.png)

Từ đây, mình có thể bật `enable_xp_cmdshell`

![image](/assets/img/HTB/season9/Signed/image24.png)
...
![image](/assets/img/HTB/season9/Signed/image25.png)

![image](/assets/img/HTB/season9/Signed/image26.png)

![image](/assets/img/HTB/season9/Signed/image27.png)

Sau khi tìm kiếm thì mình sẽ upload 1 reverver shell như sau: 

![image](/assets/img/HTB/season9/Signed/image28.png)

Sau khi upload thành công 

![image](/assets/img/HTB/season9/Signed/image29.png)

Tiếp theo mình khởi động metatsploit và setup để có thể có kết nối. 

![image](/assets/img/HTB/season9/Signed/image30.png)
...
![image](/assets/img/HTB/season9/Signed/image31.png)

Như vậy hoàn thành kết nối. 

![image](/assets/img/HTB/season9/Signed/image32.png)
...
![image](/assets/img/HTB/season9/Signed/image33.png)

Hoặc dùng 

![image](/assets/img/HTB/season9/Signed/image34.png)

Từ đây mình mở kết nối trên target. 

![image](/assets/img/HTB/season9/Signed/image35.png)

Trên máy attack thì mở kết nối để nhận 

![image](/assets/img/HTB/season9/Signed/image36.png)
...
![image](/assets/img/HTB/season9/Signed/image37.png)
...
![image](/assets/img/HTB/season9/Signed/image45.png)

```SQL
SELECT * FROM OPENROWSET(BULK 'C:\Users\Administrator\Desktop\root.txt',SINGLE_CLOB) AS x;
```

![image](/assets/img/HTB/season9/Signed/image46.png)
...
![image](/assets/img/HTB/season9/Signed/image48.png)

Sau khi upload thì dựa vào reverse shell lúc đầu mình thực hiện chạy. 

![image](/assets/img/HTB/season9/Signed/image49.png)

Quay lại chỗ netcat lắng nghe port 9999. 

![image](/assets/img/HTB/season9/Signed/image50.png)

![image](/assets/img/HTB/season9/Signed/image51.png)

![image](/assets/img/HTB/season9/Signed/image47.png)