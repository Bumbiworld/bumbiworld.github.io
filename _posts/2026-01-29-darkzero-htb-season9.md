---
title: DarkZero Retired Machine [Hard]
date: 2026-01-29
tags: [htb-machine, hard, windows, season9]
...
![image](/assets/img/HTB/season9/DarkZero/image1.png)
...
![image](/assets/img/HTB/season9/DarkZero/image2.png)

![image](/assets/img/HTB/season9/DarkZero/image3.png)
...
![image](/assets/img/HTB/season9/DarkZero/image4.png)

Điều đầu tiên cần kiểm tra là có link tới server nào ko ? 

![image](/assets/img/HTB/season9/DarkZero/image5.png)
...
![image](/assets/img/HTB/season9/DarkZero/image6.png)
...
![image](/assets/img/HTB/season9/DarkZero/image16.png)
...
![image](/assets/img/HTB/season9/DarkZero/image17.png)
...
![image](/assets/img/HTB/season9/DarkZero/image18.png)

#### Cách khai thác mà ko dùng tới metasploit

Đầu tiên thì mình dùng `xp_cmdshell` để list ip trên **DC02**

![image](/assets/img/HTB/season9/DarkZero/image19.png)
...
![image](/assets/img/HTB/season9/DarkZero/image28.png)

Sau đó, dùng tool `impacket-secretsdump` để dump hash, nhưng giờ bị như thế này. 

![image](/assets/img/HTB/season9/DarkZero/image29.png)
...
![image](/assets/img/HTB/season9/DarkZero/image30.png)

Sau khi có hash thì mình dùng `evil-winrm` để vào

![image](/assets/img/HTB/season9/DarkZero/image31.png)

Từ đây, mình có thể leo vào bằng tài khoản Admin, sau đó mình có thể đọc `root.txt`

![image](/assets/img/HTB/season9/DarkZero/image32.png)

![image](/assets/img/HTB/season9/DarkZero/image33.png)
