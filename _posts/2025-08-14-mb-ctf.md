---
title: MB Bank CTF - WEB
date: 2025-08-14
tags: [ctf, web, mb-bank]
...
Phần login:
![image](/assets/img/CTF/mb-bank/quickblog/image1.png)

Phần register: 
![image](/assets/img/CTF/mb-bank/quickblog/image2.png)

Sau khi đăng ký và đăng nhập thì vào được dashboard: 

![image](/assets/img/CTF/mb-bank/quickblog/image3.png)

![image](/assets/img/CTF/mb-bank/quickblog/image4.png)

## Review Source Code 

![image](/assets/img/CTF/mb-bank/quickblog/image5.png)

 thư mục của project như trên. 

Đọc qua file `requirement.txt`

![image](/assets/img/CTF/mb-bank/quickblog/image6.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image7.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image8.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image9.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image10.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image11.png)

Phần này lấy password admin bằng biến môi trường và set admin_user. 

![image](/assets/img/CTF/mb-bank/quickblog/image12.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image13.png)

Dưới đây thì các nội dung của post được encode lại dưới dạng base64. Và ghi các thông tin ngày tháng. 

![image](/assets/img/CTF/mb-bank/quickblog/image14.png)

Có thêm 1 biến đếm bài là `post_counter=8`

![image](/assets/img/CTF/mb-bank/quickblog/image15.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image16.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image17.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image18.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image19.png)

Ở đây thì nếu có được tài khoản admin thì có page dành cho admin có chức năng upload. 

![image](/assets/img/CTF/mb-bank/quickblog/image20.png)

Ở đây thì chỗ render ra link Upload trong trang Admin đã upload.

![image](/assets/img/CTF/mb-bank/quickblog/image21.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image22.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image23.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image24.png)

Đây là phần sẽ render ra các template trong đó các file javascript là: 
- `markdown2html.js`
- `app.js` 

![image](/assets/img/CTF/mb-bank/quickblog/image25.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image26.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image27.png)

Dùng các biến để set ban đầu cho việc lập trình lúc sau. 

![image](/assets/img/CTF/mb-bank/quickblog/image28.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image29.png)

![image](/assets/img/CTF/mb-bank/quickblog/image30.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image31.png)

Khi lấy codeLanguage thì ko thoát dấu `'` thì hoàn toàn có thể bị inject vào để thoát dấu `'`. 

## Khai thác 

![image](/assets/img/CTF/mb-bank/quickblog/image32.png)

Khi đó nó sẽ xử lý như sau: 

![image](/assets/img/CTF/mb-bank/quickblog/image33.png)

Từ đây, mình có thể inject payload này như sau: 

![image](/assets/img/CTF/mb-bank/quickblog/image34.png)

Ứng dụng xử lý như sau: 

![image](/assets/img/CTF/mb-bank/quickblog/image35.png)

Như vậy hoàn toàn mình có thể inject để dẫn đến XSS như sau: 

![image](/assets/img/CTF/mb-bank/quickblog/image36.png)

![image](/assets/img/CTF/mb-bank/quickblog/image37.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image38.png)
...
![image](/assets/img/CTF/mb-bank/quickblog/image50.png)
