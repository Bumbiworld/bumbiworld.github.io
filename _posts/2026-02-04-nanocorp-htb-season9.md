---
title: NanoCorp Retired Machine [Hard]
date: 2026-02-04
...
![image](/assets/img/HTB/season9/NanoCorp/image%201.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%202.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%203.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%204.png)

Sau khi mình upload thành công.

![image](/assets/img/HTB/season9/NanoCorp/image%205.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%206.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%207.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%208.png)

Cho nên mình thực hiện là mình add user **`web_svc`** vào group trước đã. 

![image](/assets/img/HTB/season9/NanoCorp/image%209.png)

Vậy từ đây mình sẽ reset password cho user **`MONITORING_SVC@NANOCORP.HTB`** 

![image](/assets/img/HTB/season9/NanoCorp/image%2010.png)

Mà user này lại có thể remote tới host **`DC01.NANOCORP.HTB`** 

![image](/assets/img/HTB/season9/NanoCorp/image%2011.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%2012.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%2013.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%2014.png)

Mà nó lại chạy dưới quyền **`\\NT AUTHORITY\SYSTEM`** → có thể leo lên **`root`** 

Sau khi tìm kiếm thì thấy có 1 CVE 

![image](/assets/img/HTB/season9/NanoCorp/image%2015.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%2016.png)

Đồng thời thì có vẻ nó được trigger từ dòng lệnh này.

![image](/assets/img/HTB/season9/NanoCorp/image%2017.png)

Cho nên mình phải check thử xem có file này nằm trên mục tiêu ko. 

![image](/assets/img/HTB/season9/NanoCorp/image%2018.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%2019.png)
...
![image](/assets/img/HTB/season9/NanoCorp/image%2020.png)

Giờ thì mình thử trigger lại trên user **`web_svc`** 

![image](/assets/img/HTB/season9/NanoCorp/image%2021.png)

![image](/assets/img/HTB/season9/NanoCorp/image%2022.png)

Mình thấy nó đã thay đổi PID được tạo và điều đó nó đã trigger trên **`web_svc`** 

![image](/assets/img/HTB/season9/NanoCorp/image%2023.png)

Mình đã vào được trong folder **`TEMP`** 

![image](/assets/img/HTB/season9/NanoCorp/image%2024.png)
