...
![image](/assets/img/CTF/byuctf-2025/image1.png)
...
![image](/assets/img/CTF/byuctf-2025/image2.png)

Mà adminCookie được ký bằng `userId` là `admin`

![image](/assets/img/CTF/byuctf-2025/image3.png)

Ở file `server.js`, thì nó có như sau:
![image](/assets/img/CTF/byuctf-2025/image4.png)
...
![image](/assets/img/CTF/byuctf-2025/image5.png)

Sau đó mình host bằng ngrok

![image](/assets/img/CTF/byuctf-2025/image6.png)

Rồi đưa link cho Bot

![image](/assets/img/CTF/byuctf-2025/image7.png)
Bot click thành công!

![image](/assets/img/CTF/byuctf-2025/image8.png)

Sau khi decode thì được.

![image](/assets/img/CTF/byuctf-2025/image9.png)
...
![image](/assets/img/CTF/byuctf-2025/image10.png)
...
![image](/assets/img/CTF/byuctf-2025/image11.png)

Decode ra thì được: 

![image](/assets/img/CTF/byuctf-2025/image12.png)

Thì trong source có logic như sau: 

![image](/assets/img/CTF/byuctf-2025/image13.png)
...
![image](/assets/img/CTF/byuctf-2025/image14.png)
...
![image](/assets/img/CTF/byuctf-2025/image15.png)
...
![image](/assets/img/CTF/byuctf-2025/image16.png)
...
![image](/assets/img/CTF/byuctf-2025/image17.png)

Nó nhảy ra lỗi như sau: 

![image](/assets/img/CTF/byuctf-2025/image18.png)
...
![image](/assets/img/CTF/byuctf-2025/image25.png)
...
![image](/assets/img/CTF/byuctf-2025/image26.png)
...
![image](/assets/img/CTF/byuctf-2025/image30.png)

Mình cũng được cung cấp 1 source public. 

Bài này được xây dựng theo 1 mô hình: **Client --> Proxy --> Backend**

![image](/assets/img/CTF/byuctf-2025/image31.png)

![image](/assets/img/CTF/byuctf-2025/image32.png)
...
![image](/assets/img/CTF/byuctf-2025/image33.png)
...
![image](/assets/img/CTF/byuctf-2025/image34.png)
...
![image](/assets/img/CTF/byuctf-2025/image37.png)

Sau khi decode header thì nó sẽ như sau: 

![image](/assets/img/CTF/byuctf-2025/image38.png)
...
![image](/assets/img/CTF/byuctf-2025/image39.png)
...
![image](/assets/img/CTF/byuctf-2025/image40.png)
...
![image](/assets/img/CTF/byuctf-2025/image41.png)
...
![image](/assets/img/CTF/byuctf-2025/image42.png)
...
![image](/assets/img/CTF/byuctf-2025/image43.png)
...
![image](/assets/img/CTF/byuctf-2025/image44.png)
...
![image](/assets/img/CTF/byuctf-2025/image45.png)
