...
Vì cú pháp template được xử lý ở server, attacker có thể nhét payload SSTI vào tham số này, ví dụ: http://vulnerable-website.com/?name=&#123;&#123;payload&#125;&#125;

## Cấu trúc tấn công SSTI 

![image](/assets/img/PortSwigger/ssti/image1.png)
...
engine.render("Hello &#123;&#123;"+greeting+"&125;&125;", data)
...
![image](/assets/img/PortSwigger/ssti/image2.png)
...
![image](/assets/img/PortSwigger/ssti/image3.png)

Thì nó thông qua tham số `message`. Và mình tìm hiểu template engine của ERB là: 

![image](/assets/img/PortSwigger/ssti/image4.png)

Thì mình thử dùng `<%=7*7%>` thì payload nó sẽ in ra: 

![image](/assets/img/PortSwigger/ssti/image5.png)

Từ đây, thì mình đọc file `/etc/passwd`

![image](/assets/img/PortSwigger/ssti/image6.png)
...
![image](/assets/img/PortSwigger/ssti/image7.png)
...
![image](/assets/img/PortSwigger/ssti/image8.png)

Mình sẽ truyền payload **&#125;&#125;&#123;&#123;7*7&#125;&#125;** để xem nó có thực thi ko. 

![image](/assets/img/PortSwigger/ssti/image9.png)

Kiểm tra lại phần hiển thị tên trong bài post thì như sau: 

![image](/assets/img/PortSwigger/ssti/image10.png)
...
![image](/assets/img/PortSwigger/ssti/image11.png)

Sau khi reload lại thì như sau: 

![image](/assets/img/PortSwigger/ssti/image12.png)

Vậy thì truyền payload để xóa file thành công. 

![image](/assets/img/PortSwigger/ssti/image13.png)
...
![image](/assets/img/PortSwigger/ssti/image14.png)

Khi mình thử inject vào `${foobar}` thì nó như sau: 

![image](/assets/img/PortSwigger/ssti/image15.png)
...
![image](/assets/img/PortSwigger/ssti/image16.png)

Từ đây mình truyền payload để có thể xóa file. 

![image](/assets/img/PortSwigger/ssti/image17.png)
...
![image](/assets/img/PortSwigger/ssti/image18.png)
...
![image](/assets/img/PortSwigger/ssti/image19.png)

Từ đây, mình sửa lại câu lệnh execute. 

![image](/assets/img/PortSwigger/ssti/image20.png)
...
![image](/assets/img/PortSwigger/ssti/image21.png)
...
![image](/assets/img/PortSwigger/ssti/image24.png)
...
![image](/assets/img/PortSwigger/ssti/image25.png)

Mình thử inject `${7*7}` 

![image](/assets/img/PortSwigger/ssti/image26.png)

Mình thử inject vào bằng payload RCE là: `<#assign ex = "freemarker.template.utility.Execute"?new()>${ ex("id")}`

![image](/assets/img/PortSwigger/ssti/image27.png)
...
![image](/assets/img/PortSwigger/ssti/image28.png)

Từ đây, mình có thể chuyển từ decimal sang text. 

![image](/assets/img/PortSwigger/ssti/image29.png)
...
![image](/assets/img/PortSwigger/ssti/image30.png)
...
![image](/assets/img/PortSwigger/ssti/image31.png)
...
![image](/assets/img/PortSwigger/ssti/image32.png)
...
![image](/assets/img/PortSwigger/ssti/image33.png)
...
![image](/assets/img/PortSwigger/ssti/image34.png)
...
![image](/assets/img/PortSwigger/ssti/image35.png)
