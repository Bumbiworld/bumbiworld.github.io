---
title: Imagery Retired Machine [Medium]
date: 2026-01-28
...
![image](/assets/img/HTB/season9/Imagery/image1.png)
...
![image](/assets/img/HTB/season9/Imagery/image2.png)
...
![image](/assets/img/HTB/season9/Imagery/image7.png)
...
![image](/assets/img/HTB/season9/Imagery/image12.png)

![image](/assets/img/HTB/season9/Imagery/image13.png)

Có vẻ là nó đã đọc lun nội dung của file cung cấp. 

![image](/assets/img/HTB/season9/Imagery/image14.png)
...
![image](/assets/img/HTB/season9/Imagery/image15.png)
...
![image](/assets/img/HTB/season9/Imagery/image23.png)

Đối với option `Rotate`:

![image](/assets/img/HTB/season9/Imagery/image24.png)
...
![image](/assets/img/HTB/season9/Imagery/image28.png)

Hoàn toàn nhận vào các số nguyên, mình tiếp tục test. 

![image](/assets/img/HTB/season9/Imagery/image29.png)
...
![image](/assets/img/HTB/season9/Imagery/image30.png)

Từ đây thì mình hoàn toàn có thể RCE. Thông qua [rev-shell]("https://www.revshells.com/") để lấy reverse shell. 

![image](/assets/img/HTB/season9/Imagery/image31.png)

![image](/assets/img/HTB/season9/Imagery/image32.png)

Từ đây mình có list toàn bộ source 

![image](/assets/img/HTB/season9/Imagery/image33.png)

Mình đi vào folder **bot** 

![image](/assets/img/HTB/season9/Imagery/image34.png)
...
![image](/assets/img/HTB/season9/Imagery/image35.png)

Có file `/var/backup` -> lấy thử 

![image](/assets/img/HTB/season9/Imagery/image36.png)
...
![image](/assets/img/HTB/season9/Imagery/image37.png)
...
![image](/assets/img/HTB/season9/Imagery/image38.png)
...
![image](/assets/img/HTB/season9/Imagery/image39.png)

Lại đem đi crack pass típ. Crack user **mark** với **web**

![image](/assets/img/HTB/season9/Imagery/image40.png)

Vậy chỉ crack được password của mark, đổi sang user mark coi có gì khác ko. 

![image](/assets/img/HTB/season9/Imagery/image41.png)

Sau đó test trên user này bằng **sudo -l**

![image](/assets/img/HTB/season9/Imagery/image42.png)

Thì thấy có **charcol**, ở đây nó chạy với **root** nhưng ko yêu cầu password

![image](/assets/img/HTB/season9/Imagery/image43.png)
...
![image](/assets/img/HTB/season9/Imagery/image44.png)

Sau đó, mình cần `reset` lại `password` 

![image](/assets/img/HTB/season9/Imagery/image45.png)

Chạy lại thì chọn `no password `

![image](/assets/img/HTB/season9/Imagery/image46.png)

Sau khi mò thì cũng đã vào được `charcol`

![image](/assets/img/HTB/season9/Imagery/image47.png)

Mình chạy lệnh **help**

![image](/assets/img/HTB/season9/Imagery/image48.png)
...
![image](/assets/img/HTB/season9/Imagery/image49.png)

Quay lại netcat thì hoàn mình đã có quyền root 

![image](/assets/img/HTB/season9/Imagery/image50.png)


Tiếp tục mò trên folder của user này. 

![image](/assets/img/HTB/season9/Imagery/image51.png)

![image](/assets/img/HTB/season9/Imagery/image52.png)
